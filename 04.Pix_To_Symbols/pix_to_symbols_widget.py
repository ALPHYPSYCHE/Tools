...
class Ui_alphy_pix2symb_converter(object):
    ...
    def retranslateUi(self, alphy_pix2symb_converter):
        ...
        source_addresss = "G:\MY PYTHONS\pix to symbols\dg.jpg"
        alphy_pix2symb_converter.setWindowTitle(_translate("alphy_pix2symb_converter", "ALPHY PICTURE TO SYMBOLS CONVERTER"))
        self.label_width.setText(_translate("alphy_pix2symb_converter", "Width"))
        self.lineEdit_width.setText(_translate("alphy_pix2symb_converter", "333"))
        self.label_hight.setText(_translate("alphy_pix2symb_converter", "Hight"))
        self.lineEdit_hight.setText(_translate("alphy_pix2symb_converter", "333"))
        self.label_scale.setText(_translate("alphy_pix2symb_converter", "Scale"))
        self.lineEdit_scale.setText(_translate("alphy_pix2symb_converter", "33"))
        self.label_usesymb.setText(_translate("alphy_pix2symb_converter", "Use Symbols"))
        self.lineEdit_symb_use.setText(_translate("alphy_pix2symb_converter", "Ñ@#W$%^&.,:9876543210|/><abcdefghijklmnopqrstuvwxyz_-=+"))
        self.label_saveadd.setText(_translate("alphy_pix2symb_converter", "Save Address"))
        self.lineEdit_save_address.setText(_translate("alphy_pix2symb_converter", "It is Automatic & it Will save in the source folder"))
        self.lineEdit_source_add.setText(_translate("alphy_pix2symb_converter", source_addresss))
    ...
    def myconvert(self):
        ...
        new_correct_name = new_name_split[0]+ "_New_Version." + new_name_split[1]
        ...
        picture_to_ascii_rgb(address, final_new_add, characters, (width, hight), scale=scale, font='C:\\Windows\\Fonts\\BRLNSB.TTF')
        ...
        # Done = QMessageBox.question(self, " Your New Version is ready ! ",
        #                                   "Your New Version is ready !", QMessageBox.OK | QMessageBox.Open)
        # if Done == QMessageBox.OK:
        #     pass
        # elif Done == QMessageBox.Open:
        #     aa = open(str(new_add))
